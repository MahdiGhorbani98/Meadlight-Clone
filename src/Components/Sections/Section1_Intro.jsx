        ...
        <div className="Section1_Intro_Container">
            <div className="Section1_Intro">
                ...
                svg={
                    ...
                    <path className="lineOrange" fill="none" stroke="#ff91a3" strokeLinecap="round" strokeLinejoin="round" strokeWidth="5" vectorEffect="non-scaling-stroke" d="M3.1 4.5c42.5-5.4 86.3 6.1 128.9.9" style={{strokeDashoffset:  645.611, strokeDasharray: 645.611}}></path>
                    </svg>
                }
                />
            ...
            <div onMouseEnter={()=>PlaySvg()} onMouseLeave={()=>ReverseSvg()} className="div__scroll_to_dicover">
                ...
                <p className="scroll__to__discover">
                    <SvgImport 
                    svg={
                        <svg style={{position: 'absolute', width: 92, top: -40, left: 25}} data-v-c2a89eaa="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122 126">
